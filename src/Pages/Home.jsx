			...
			<div className="flex flex-col min-h-screen">
				...
				<div className="py-20">
					<div className="container mx-auto px-6 md:px-12 xl:px-32">
						...
						<div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-screen-lg m-auto">
							{/* Course Card */}
							{courses.slice(0, 4).map((course) => (
								...
								>
									...
									<div className="px-6 pt-4 pb-2">
										<Link
											to={`/Course/${course.courseId}`}
											className="inline-block bg-indigo-600 hover:bg-indigo-700 text-white py-1 px-3 rounded"
										>
											Learn More
										</Link>
									</div>
