...
function CreateChapter() {
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			await axios.post(
				`https://localhost:7291/api/Chapter/Course/${courseId}/addChapter`,
				{
			...
			Swal.fire("Created", "Create chapter successfully!", "success");
			navigate(`/Course/${courseId}/Edit`);
		} catch (error) {
			console.error("Error when create chapter:", error);
			Swal.fire("Error when create chapter.");
		}
	};
