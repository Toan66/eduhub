...
export default () => {
    ...
    useEffect(() => {
        ...
        const fetchUserAvatar = async () => {
            try {
                const response = await axios.get('https://localhost:7291/api/User/avatar', { withCredentials: true },);
                if (response.status === 200) {
                                    ...
                                    <div className="relative text-left ">
                                        <div className="group">
                                            <button type="button"
                                                ...
                                                {/* avatar */}
                                                <img title='avatar' className=' size-10' src={userAvatar} />
                                            ...
                                            <div className="absolute right-0 w-40 origin-top-left bg-white divide-y divide-gray-100 rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition duration-300">
                                                <div className="py-1">
